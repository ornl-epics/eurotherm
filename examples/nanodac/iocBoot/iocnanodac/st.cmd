...
drvModbusAsynConfigure("n1l1", "n1ip", 1, 4, 512, 22, 4, 1000, 0)
# Read the loop 2 main params (640 to 661)
drvModbusAsynConfigure("n1l2", "n1ip", 1, 4, 640, 22, 4, 1000, 0)
...
drvModbusAsynConfigure("n1l1o", "n1ip", 1, 4, 5724, 64, 4, 1000, 0)
# Read functions for loop 2 output and setpoint params (5980 to 6043)
drvModbusAsynConfigure("n1l2o", "n1ip", 1, 4, 5980, 64, 4, 1000, 0)
